...
# TODO: sensor update moet kijken naar huidige lat long  van device / zone waarop gebaseerd is

# DONE: volgens mij worden maar een paar van de sensoren gerefreshed...

# TODO: Logo overal toevoegen

# TODO: set icon for sensor
...
# TODO: can an automation be added to the package? or do I provide it in the documentation as an example?
